...
class Ajax {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_bricks_get_dynamic_data_value', [ $this, 'get_dynamic_data_value' ] );
	...
	/**
	 * Parse string through dynamic data logic
	 *
	 * To parse _cssID for DD values.
	 *
	 * @since 1.7.1
	 */
	public function get_dynamic_data_value() {
		wp_send_json_success(
			[
				'value' => isset( $_POST['value'] ) && isset( $_POST['postId'] ) ? bricks_render_dynamic_data( $_POST['value'], $_POST['postId'] ) : false,
			]
		);
	}
