...
class Builder {
	...
	public static function get_google_fonts() {
		 ...
		 *
		 * Change $get_file_contents above to source & set next var to true.
		 *
		 * @since 1.7.1
		 */
		...
		if ( $google_fonts_generate ) {
			$google_fonts = Helpers::get_file_contents( BRICKS_URL . 'src/assets/fonts/google-fonts.json' );
		...
		$google_fonts = Helpers::get_file_contents( BRICKS_URL_ASSETS . 'fonts/google-fonts.min.json' );
