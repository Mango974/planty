...
// NOTE: Not useful in 'lightboxVideo'
$controls['lightboxHeight'] = [
	...
	'css'   => [
		[
			'property' => 'height',
			'selector' => '.pswp__container .pswp__content',
		],
	],
];
...
$controls['lightboxCloseColor'] = [
	...
	'css'   => [
		[
			'property' => 'color',
			'selector' => '.pswp__button.pswp__button--close svg',
		],
	],
];
...
$controls['lightboxCloseSize'] = [
	...
	'css'   => [
		[
			'property' => 'width',
			'selector' => '.pswp__button.pswp__button--close',
		],
		[
			'property' => 'height',
			'selector' => '.pswp__button.pswp__button--close',
