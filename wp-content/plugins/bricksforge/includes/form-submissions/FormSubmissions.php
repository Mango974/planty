...
class FormSubmissions
{
    ...
    public function add_submenu()
    {
        add_submenu_page(
            'bricks',
            // Parent menu slug
            __('Form Submissions', 'bricksforge'),
            // Page title
            __('Form Submissions', 'bricksforge'),
            // Menu title
            'manage_options',
