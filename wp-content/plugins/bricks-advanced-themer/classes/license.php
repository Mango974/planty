...
class AT__license {
    ...
    public static function brxc_plugin_updater() {
        ...
        // setup the updater
        $edd_updater = new AT__Plugin_Updater(
            BRXC_STORE_URL,
    ...
    *************************************/
    ...
    public static function brxc_license_key_settings_field() {
        ...
        ?>
        <p class="description">
            <strong>Enter your license key.</strong> You can manage your license, update payment method and view your invoices right from <a href="https://advancedthemer.com/checkout/order-history/">your account.</a>
        </p>
        <?php
        printf(
            '<input type="password" class="regular-text" id="brxc_license_key" name="brxc_license_key" value="%s" />',
            esc_attr( $license )
        );
        $button = array(
    ...
    public static function brxc_register_option() {
        register_setting( 'brxc_license', 'brxc_license_key', 'Advanced_Themer_Bricks\AT__License::edd_sanitize_license' );
    }
