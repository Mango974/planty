    ...
    <div class="brxc-accordion-panel">
        ...
        <div class="brxc-prompt-options-wrapper three-col">
            ...
            <div class="brxc-prompt-option">
                ...
                <div class="brxc__range">
                    <input type="range" min="0" max="32000" step="1" value="100" name="<?php echo esc_attr($prefix);?><?php echo esc_attr($type);?>MaxTokens" id="<?php echo esc_attr($prefix);?><?php echo esc_attr($type);?>MaxTokens" class="brxc-input__range" oninput="document.querySelector('<?php echo esc_attr($pannel);?> #<?php echo esc_attr($prefix);?><?php echo esc_attr($type);?>MaxTokensValue').innerHTML = parseInt(event.target.value).toFixed(0)">
                    <span id="<?php echo esc_attr($prefix);?><?php echo esc_attr($type);?>MaxTokensValue">100</span>
                </div>
            </div>
            <div class="brxc-prompt-option">
